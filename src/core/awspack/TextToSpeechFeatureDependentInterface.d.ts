 ...
 * @property {Object} EVENT_DEPENDENCIES.TextToSpeechFeature - Events that are specific to the TextToSpeechFeature.
 * @property {string} [EVENT_DEPENDENCIES.TextToSpeechFeature.play='_onPlay']  The name of the method that will be executed when TextToSpeechFeature play events are emitted.
 * @property {string} [EVENT_DEPENDENCIES.TextToSpeechFeature.pause='_onPause'] - The name of the method that will be executed when TextToSpeechFeature pause events are emitted.
 * @property {string} [EVENT_DEPENDENCIES.TextToSpeechFeature.resume='_onResume'] - The name of the method that will be executed when TextToSpeechFeature resume events are emitted.
 * @property {string} [EVENT_DEPENDENCIES.TextToSpeechFeature.stop='_onStop'] - The name of the method that will be executed when TextToSpeechFeature stop events are emitted.
 * @property {string} [EVENT_DEPENDENCIES.TextToSpeechFeature.sentence='_onSentence'] - The name of the method that will be executed when TextToSpeechFeature sentence events are emitted.
 * @property {string} [EVENT_DEPENDENCIES.TextToSpeechFeature.word='_onWord'] - The name of the method that will be executed when TextToSpeechFeature word events are emitted.
